...
export const adminResources: AdminResource[] = [
  ...
  { path: "subjects", label: "Subjects", icon: GraduationCap, color: "from-emerald-500 to-teal-600" },
  { path: "notes", label: "Notes", icon: NotebookPen, color: "from-amber-500 to-orange-600" },
  { path: "books", label: "Books", icon: BookOpen, color: "from-rose-500 to-pink-600" },
